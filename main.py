...
# Display Window
screen_width, screen_height = 515, 515
...
def draw_snake():
    ...
    pygame.draw.rect(screen, (0,255,0), (snek_head_x * cell_size + offset, snek_head_y * cell_size + offset, cell_size, cell_size))
...
def draw_apple():
    pygame.draw.rect(screen, (255,0,0), (apple_x * cell_size + offset, apple_y * cell_size + offset, cell_size, cell_size))
